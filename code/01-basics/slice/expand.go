...
// DemoExpand 演示 slice 扩容规则（Go 1.18+）
//
// ============================================================================
// 扩容算法（runtime/slice.go growslice）：
//   1. 如果 cap < 256：newcap = cap * 2（翻倍）
//   2. 如果 cap ≥ 256：newcap = (cap + 3*256) / 4（阶梯 ~1.25x）
//   3. 最后按内存对齐（size class）取整
// ============================================================================
func DemoExpand() {
